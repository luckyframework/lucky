...
- Added: some inline docs to using `ENV["LUCK_TASK"]`. [#595 in Lucky CLI](https://github.com/luckyframework/lucky_cli/pull/595/files)
...
- Updated: the Heroku Buildpack to now build all proper targets. Accompanies #601 in Lucky CLI. [#11 in Heroku Buildpack](https://github.com/luckyframework/heroku-buildpack-crystal/pull/11)
