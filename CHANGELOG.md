...
- Updated: SaveOperation callback methods `after_save` and `after_commit` work with blocks, and more. [#481 in Avram](https://github.com/luckyframework/avram/pull/481)
...
- Added: conditional callbacks for `SaveOperation`. [#495 in Avram](https://github.com/luckyframework/avram/pull/495)
...
- Added: new `after_completed` callback on `SaveOperation` which is called even if no updates are made. [#544 in Avram](https://github.com/luckyframework/avram/pull/544)
