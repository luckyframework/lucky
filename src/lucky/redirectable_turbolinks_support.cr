...
# Needs to change browser address bar at last request, see https://github.com/turbo/turbo#following-redirects
#
...
module Lucky::RedirectableTurboSupport
  ...
  private def set_turbo_location_header_from_session
    if turbo_location = cookies.get?(:_turbo_location)
      ...
      # change browser address bar at last request, see https://github.com/turbo/turbo#following-redirects
